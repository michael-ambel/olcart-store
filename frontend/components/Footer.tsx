    ...
    <footer className="w-full px-[84px] my-[80px]">
      <div className="flex flex-col w-full bg-bgs px-[35px] py-[20px]">
          ...
          <div className="w-[300px]">
            ...
            >
              ...
              <textarea
                ...
                onChange={handleChange}
                className=" w-[300px] px-[10px] rounded-[10px] border border-bl focus:no-underline"
                placeholder="Write your feedback here..."
                rows={4}
              ></textarea>

              <button type="submit" className=" bg-mo py-2 px-4 rounded-full">
                Submit
              </button>
            </form>
          </div>
        ...
        <div className="flex justify-between w-full my-[20px]">
          ...
          <p className="text-[14px]">By Michael A.</p>
        </div>
      </div>
    </footer>
  );
